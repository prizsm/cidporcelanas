...
modelo :: [(Text, Double)]
modelo = [("004", 18.95), ("024", 18.95), ("028", 18.95), ("032", 18.95), ("043", 18.95), ("094", 18.95), ("095", 18.95), ("275", 18.95), ("320", 18.95), ("401", 18.95), ("416", 18.95), ("418", 18.95), ("419", 18.95), ("426", 18.95), ("428", 18.95), ("432", 18.95), ("438", 18.95), ("440", 18.95), ("511", 18.95), ("523", 18.95), ("712", 18.95), ("724", 18.95), ("765", 18.95), ("766", 18.95), ("767", 18.95), ("769", 18.95), ("775", 18.95), ("794", 18.95), ("802", 18.95), ("810", 18.95)]
            ...
            defaultLayout $ do
                ...
                [whamlet|
                    <div class="orcamento1"><h2>Orçamento de Molduras</h2>
                        ...
                        <p class="center"><a href="@{ModelosMoldurasR}" class="link">VEJA AQUI MODELOS DE MOLDURAS DISPONÍVEIS</a></p>
            ...
            defaultLayout $ do
                ...
                [whamlet|
                    <div class="orcamento1"><h2>Orçamento de Molduras</h2>
                        ...
                        <p><a href="@{ModelosMoldurasR}" class="link">VEJA AQUI MODELOS DE MOLDURAS DISPONÍVEIS</a></p>
...
getOrcmoldurafinalR orcmolid = do
                ...
                ^{menu2}
                    $forall Entity orcmolid orcmoldura <- molduras
                        <div class="orcamento1"><h2>Orçamento de número #{show $ fromSqlKey orcmolid}</h2>
                            ...
                            <p> <span class="negrito">Valor do quadro só com a Moldura: </span> R$ #{show (somoldura orcmoldura)}
                            <p> <span class="negrito">Valor do quadro com Moldura e Vidro Antirreflexo: </span> R$ #{show (molduravar orcmoldura)}
                            <p> <span class="negrito">Valor do quadro com Moldura e Vidro Comum: </span> R$ #{show (molduravc orcmoldura)}
                            <p> <span class="negrito">Valor do quadro com Moldura e Espelho Simples: </span> R$ #{show (espelho orcmoldura)}<br><br>
                                <h3> OBSERVAÇÕES:</h3>
            ...
            where
                ...
                molduravar orcmoldura = ((perimetro orcmoldura) * ((orcmolduraModelo orcmoldura) + (orcmolduraPaspatour orcmoldura))) + ((area orcmoldura) * 250)
    
                molduravc :: Orcmoldura -> Double
                molduravc orcmoldura = ((perimetro orcmoldura) * ((orcmolduraModelo orcmoldura) + (orcmolduraPaspatour orcmoldura))) + ((area orcmoldura) * 200)
...
getOrcmoldura1finalR orcmoid = do
                ...
                ^{menu2}
                    $forall Entity orcmoid orcmoldura1 <- moldurass
                        <div class="orcamento1"><h2>Orçamento de número #{show $ fromSqlKey orcmoid}</h2>
                            ...
                            <p> <span class="negrito">Valor do quadro só com a Moldura: </span> R$ #{show (somoldura orcmoldura1)}
                            <p> <span class="negrito">Valor do quadro com Moldura e Vidro Antirreflexo: </span> R$ #{show (molduravar orcmoldura1)}
                            <p> <span class="negrito">Valor do quadro com Moldura e Vidro Comum: </span> R$ #{show (molduravc orcmoldura1)}
                            <p> <span class="negrito">Valor do quadro com Moldura e Espelho Simples: </span> R$ #{show (espelho orcmoldura1)}<br><br>
                                <h3> OBSERVAÇÕES:</h3>
                                <p> - Caso você acredite que o valor do orçamento é maior que o esperado, por favor refaça o orçamento e preencha conforme descrição prévia;<br>
                                <p> - Os orçamentos realizados neste site são referentes a última tabela vingente, mas para ele ser concretizado deve ser levado o pedido, ou número do orçamento a loja física;<br>
                                <p> - Modelos e cores estão sujeitos a disponibilidade no ato do pedido;<br>
            ...
            where
                ...
                molduravar orcmoldura1 = ((perimetro orcmoldura1) * ((orcmoldura1Modelo orcmoldura1) + (orcmoldura1Paspatour orcmoldura1))) + ((area orcmoldura1) * 250)
    
                molduravc :: Orcmoldura1 -> Double
                molduravc orcmoldura1 = ((perimetro orcmoldura1) * ((orcmoldura1Modelo orcmoldura1) + (orcmoldura1Paspatour orcmoldura1))) + ((area orcmoldura1) * 200)
